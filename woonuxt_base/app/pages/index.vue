  ...
  <main>
    ...
    <section class="container grid gap-4 my-24 md:grid-cols-2 lg:grid-cols-4">
      <div class="flex items-center gap-8 p-8 bg-white rounded-lg">
        ...
        <div>
          <h3 class="text-xl font-semibold">משלוח חינם</h3>
          <p class="text-sm">משלוח חינם על כל המוצרים</p>
        </div>
      </div>
      <div class="flex items-center gap-8 p-8 bg-white rounded-lg">
        <img src="/icons/moneyback.svg" width="60" height="60" alt="Money Back" loading="lazy" />
        <div>
          <h3 class="text-xl font-semibold">שביעות רצון</h3>
          <p class="text-sm">לא מרוצים מהמוצר שרכשתם? פנו אלינו!</p>
        </div>
      </div>
      <div class="flex items-center gap-8 p-8 bg-white rounded-lg">
        <img src="/icons/secure.svg" width="60" height="60" alt="Secure Payment" loading="lazy" />
        <div>
          <h3 class="text-xl font-semibold">תשלום מאובטח</h3>
          <p class="text-sm">התשלום באתר מאובטח בסטנדרטים הגבוהים ביותר</p>
        </div>
      </div>
      <div class="flex items-center gap-8 p-8 bg-white rounded-lg">
        <img src="/icons/support.svg" width="60" height="60" alt="Support 24/7" loading="lazy" />
        <div>
          <h3 class="text-xl font-semibold">תמיכה וייעוץ</h3>
          <p class="text-sm">הצוות שלנו זמין עבורכם לכל פניה</p>
        </div>
      </div>
    </section>
